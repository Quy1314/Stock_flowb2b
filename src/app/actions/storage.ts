...
export async function uploadListingDocument(userId: string, fileName: string, fileBody?: any) {
  const supabase = await createClient()
...
export async function uploadShipmentProof(userId: string, fileName: string, fileBody?: any) {
  const supabase = await createClient()
...
export async function uploadPaymentReceipt(userId: string, fileName: string, fileBody?: any) {
  const supabase = await createClient()
